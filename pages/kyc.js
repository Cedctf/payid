        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-400/50"
            >
              Login
            </motion.button>
            ...
            <div className="flex gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex-1 flex items-center justify-center py-3 bg-blue-500/10 border border-blue-400/20 rounded-xl backdrop-blur-sm hover:bg-blue-500/20 transition-all duration-200"
              >
